...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppRecipesRecipeDbTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "recipesCollection", function () {
  ...
  function srcAppRecipesRecipeDetailRecipeDetailPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RecipeDetailPage = /*#__PURE__*/function () {
      function RecipeDetailPage(activatedRoute, recipeServ) {
      ...
      _createClass(RecipeDetailPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.paramMap.subscribe(function (p) {
            if (!p.has('id')) {
              // redirect
              return;
            }

            _this.requestedId = p.get('id');
            _this.fetchedRecipe = _this.recipeServ.getRecipe(_this.requestedId);
          });
        }
      }, {
  ...
  function srcAppRecipesRecipesServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _recipe_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./recipe-db */
    "./src/app/recipes/recipe-db.ts");
    ...
    var RecipesService = /*#__PURE__*/function () {
      ...
      _createClass(RecipesService, [{
        ...
        value: function getRecipe(recipeId) {
          return Object.assign({}, this.recipes.find(function (r) {
            return recipeId === r.id;
          }));
        }
      }, {
        key: "setTitleLengthPx",
        value: function setTitleLengthPx(passAlong) {
          this.titleToken = passAlong;
        }
      }, {
        key: "getTitleLengthPx",
        value: function getTitleLengthPx() {
